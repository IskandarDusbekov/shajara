...
urlpatterns = [
    ...
    path("seo/sozlamalar/", v.seo_settings, name="seo_settings"),
    path("seo/fayllar/", v.seo_files, name="seo_files"),
    path("tizim/", v.system_health, name="system"),
    path("tizim/test-xat/", v.system_test_email, name="system_test_email"),
